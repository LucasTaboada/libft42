...
#                                                 +#+#+#+#+#+   +#+            #
#    Created: 2019/05/03 17:31:23 by ltaboada          #+#    #+#              #
#    Updated: 2019/06/06 09:27:00 by ltaboada         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRC= ft_memset.c ft_strmap.c ft_bzero.c ft_memcpy.c ft_memccpy.c ft_memmove.c \
	...
	ft_putstr_fd.c ft_putendl_fd.c ft_putnbr_fd.c ft_countwords.c ft_word_len.c \
	ft_num_len.c ft_strnstr.c ft_lstiter.c ft_lstdelone.c ft_lstdel.c ft_lstadd.c \
	ft_lstmap.c ft_lstnew.c ft_isupper.c ft_islower.c
